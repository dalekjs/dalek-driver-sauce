...
module.exports = function (grunt) {
  ...
  grunt.registerTask('preparePlato', function () {
    ...
    var platoDummyFiles = ['/report/complexity/report.history.json', '/report/complexity/files/report.history.json',
      ...
      '/report/complexity/files/lib_browser_js/report.history.json',
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/driversauce.html')) {
      ...
      grunt.file.copy('report/docs/driversauce.html', '_raw/docs/' + lastTag + '/driversauce.html');
